 ...
 */
if (isset($_POST['package_submit']) && !empty($_POST['package_submit'])) {
        ...
        */ 
        ...
        $query = "INSERT INTO `packages` (`package_id`,`project_id`,`name`) VALUES ('$package_id','$project_id','$name')";
        $conn->query($query);
        
		$_SESSION['success']    =   "Package Entry process have been successfully completed.";
