...
<head>        
    ...
    <title>LC MANAGEMENT SYSTEM</title>
...
<body>
    ...
    <div class="login" id="login">
        <div class="wrap">
            <h1><center><b>LC MANAGEMENT SYSTEM</b></center></h1>
            <center>Enter valid email & password to login</center>
            <form id="login_form" name="login_form" method="post">
            <div class="row">
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="email"  id="email" name="email" value="" placeholder="Login Email" class="form-control validate[required]"  autocomplete="off"/>
                ...
                <div class="input-group">
                    ...
                    <input type="password" id="password" name="password" value="" placeholder="Password" class="form-control validate[required]"/>
            ...
            <div class="row">
                ...
                <div class="col-md-4    TAR">
                    <input type="submit" name="login_submit"  class="btn btn-block btn-primary" value="Log In"/>
                </div>
            </div>
            </form>
            <div class="dr"><span></span></div>            
        ...
        <div class="wrap">
            ...
            <div class="row">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="login" placeholder="E-mail" class="form-control"/>
                </div>                
                <div class="dr"><span></span></div>                
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-exclamation-sign"></i></span>
