        ...
        var j = function (e) {
            ...
            function m(a, b, c) {
                ...
                !d.bSortable || (-1 == h.inArray("asc", d.asSorting) && -1 == h.inArray("desc", d.asSorting))
                    ...
                    : -1 == h.inArray("asc", d.asSorting) && -1 != h.inArray("desc", d.asSorting) && ((d.sSortingClass = a.oClasses.sSortableDesc), (d.sSortingClassJUI = a.oClasses.sSortJUIDescAllowed));
            }
            function k(a) {
                ...
                if ((c = i.fnGetData(a.aoData[b]._aData, d)) === n)
                    return (
                        a.iDrawError != a.iDraw &&
                            ...
                            (D(a, 0, "Requested unknown parameter " + ("function" == typeof i.mData ? "{mData function}" : "'" + i.mData + "'") + " from the data source for row " + b), (a.iDrawError = a.iDraw)),
                        i.sDefaultContent
                    );
            ...
            function x(a) {
                ...
                if (-1 !== h.inArray(!1, b)) E(a, !1);
                    ...
                    a.iInitDisplayStart !== n &&
                        ...
                        ((a._iDisplayStart = a.oFeatures.bServerSide ? a.iInitDisplayStart : a.iInitDisplayStart >= a.fnRecordsDisplay() ? 0 : a.iInitDisplayStart), (a.iInitDisplayStart = -1), y(a));
            ...
            function La(a) {
                ...
                if ("" === a.oScroll.sX) {
                    ...
                    "" !== a.oScroll.sXInner
                        ...
                        ? ((a.nTable.style.width = q(i - a.oScroll.iBarWidth)), h(a.nTable).outerWidth() > i - a.oScroll.iBarWidth && (a.nTable.style.width = q(i)))
                ...
                if (h(a.nTable).outerWidth() < i) {
                    ...
                    "" === a.oScroll.sX
                        ? D(a, 1, "The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width.")
                        ...
                        q[c].bSortable
                            ? 0 < o.length && o[0][0] == c
                                ? (i.setAttribute("aria-sort", "asc" == o[0][1] ? "ascending" : "descending"),
                                  i.setAttribute("aria-label", e + ("asc" == (q[c].asSorting[o[0][2] + 1] ? q[c].asSorting[o[0][2] + 1] : q[c].asSorting[0]) ? G.sSortAscending : G.sSortDescending)))
                        ...
                        var e = function () {
                            ...
                            if (b.shiftKey) {
                                ...
                                1 == a.aaSorting.length && a.aaSorting[0][0] == c
                                    ? ((d = a.aaSorting[0][0]), (e = a.aaSorting[0][2] + 1), a.aoColumns[d].asSorting[e] || (e = 0), (a.aaSorting[0][1] = a.aoColumns[d].asSorting[e]), (a.aaSorting[0][2] = e))
            ...
            this.oApi = {
                ...
                _fnCreateCookie: function (a, b, c, d, e) {
                    ...
                    var c = X.location.pathname.split("/"),
                        ...
                        g;
                    null !== e
                        ? ((g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")")), (b = e(a, g, f.toGMTString(), c.join("/") + "/")))
                        ...
                        for (m = r; m <= k; m++)
                            t +=
                                n !== m
                                    ...
                                    : '<a tabindex="' + e.iTabIndex + '" class="' + B.sPageButtonActive + '">' + e.fnFormatNumber(m) + "</a>";
                        m = 0;
