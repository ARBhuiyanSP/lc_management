            ...
            <div class="col-md-12">                
                ...
                <div class="widget">
                    <div class="head">
                        ...
                        <h2>LC Form Entry [--- Industrial ---]</h2> 
						<button class="btn btn-primary" type="submit" onclick="window.location.href='lc_commercial_form.php';">Switch to LC Commercial Entry Form</button>
                    </div>                                               
                    ...
                    <div class="block-fluid">
						...
						<div class="form-group">
							...
							<div class="col-md-1 form-lebel">LC/Unit Share Amount :</div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 form-lebel">Restricted items showing individual share:</div>
                            <div class="col-md-4"><textarea name="restricted_items" class="form-control validate[required]" style="min-height: 50px;"></textarea></div>
                        </div>	
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select name="country_origin" class="select" >
                        ...
                        <div class="form-group">                        
                            <div class="col-md-12" style="text-align:right;">
                                ...
                                <input type="submit" name="industrial_submit" id="submit" class="btn btn-primary" style="" value="Submit" />
                            </div>
                            </div>
                        </div>
                    </div>                
